...
ifeq ($(config),debug_x64)
  ...
  RESCOMP = windres
  TARGETDIR = bin/Debug
  TARGET = $(TARGETDIR)/raylib-game-template
  OBJDIR = obj/x64/Debug/raylib-game-template
...
ifeq ($(config),debug_x86)
  ...
  TARGETDIR = bin/Debug
  TARGET = $(TARGETDIR)/raylib-game-template
  OBJDIR = obj/x86/Debug/raylib-game-template
  DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
  INCLUDES += -Isrc -Iinclude -Ibuild/external/raylib-master/src
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_arm64)
  ...
  TARGETDIR = bin/Debug
  TARGET = $(TARGETDIR)/raylib-game-template
  OBJDIR = obj/ARM64/Debug/raylib-game-template
  DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
  INCLUDES += -Isrc -Iinclude -Ibuild/external/raylib-master/src
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_x64)
  ...
  TARGET = $(TARGETDIR)/raylib-game-template
  OBJDIR = obj/x64/Release/raylib-game-template
...
ifeq ($(config),release_x86)
  ...
  TARGETDIR = bin/Release
  TARGET = $(TARGETDIR)/raylib-game-template
  OBJDIR = obj/x86/Release/raylib-game-template
  DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
  INCLUDES += -Isrc -Iinclude -Ibuild/external/raylib-master/src
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_arm64)
  ...
  TARGETDIR = bin/Release
  TARGET = $(TARGETDIR)/raylib-game-template
  OBJDIR = obj/ARM64/Release/raylib-game-template
  DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
  INCLUDES += -Isrc -Iinclude -Ibuild/external/raylib-master/src
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) ${CUSTOMFILES} $(OBJECTS) $(LDDEPS) $(RESOURCES) | $(TARGETDIR)
	@echo Linking raylib-game-template
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning raylib-game-template
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
